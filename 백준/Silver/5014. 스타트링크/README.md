...
- 문제 상황 : 처음 16번째줄에 방문(visited) 체크해줄 때는 시간 초과가 났다.
- 해결법 : q에서 pop하고 나서 방문 체크를 하면 q에 같은 층이 들어가는 경우가 생기기 때문에 q에 넣을 때마다 방문 체크를 해줌으로써 시간 초과 해결
